...
operaciones con compuertas cuánticas, acudiendo a su representación matricial.
...
ilegibles. Es por esto que se desarrollaron los circuitos cuánticos como estrategia de representación de algoritmos y secuencias de aplicación de compuertas cuánticas 
...
diferentes compuertas cuánticas. Cada compuerta es representada con un símbolo diferente dentro del circuito. Generalmente, las compuertas unarias son representadas como cajas 
con una etiqueta de texto que indica el tipo de compuerta. 

<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    src={`${import.meta.env.BASE_URL}/concept-qubit/unary-gates.svg`}
    alt='Compuertas unarias en un circuito cuántico'
    width='400'
    height='200'
  />
  <span style='max-width:1510px; padding:10px 40px'>
    **Figura (3):** Visualización de compuertas unitarias A, B y C en un circuito cuántico
  </span>
</div>

Por otro lado, las compuertas n-arias se representan mediante una línea que conecta diferentes qubits. 

<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    src={`${import.meta.env.BASE_URL}/concept-qubit/n-ary-gates.avif`}
    alt='Compuertas n-arias en un circuito cuántico'
    width='400'
    height='200'
  />
  <span style='max-width:1510px; padding:10px 40px'>
    **Figura (4):** Visualización de compuertas binarias Controlled NOT y Controlled Y en un circuito cuántico
  </span>
</div>
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    ...
    alt='Estructura de la primitiva EF aplicada al algoritmo de Shor, con cuatro señalizadores indicando las distintas secciones del algoritmo. Las compuertas siguen un patron escalonado del qubit de control, empezando por el ultimo (de arriba hacia abajo) y finalizando con el primero (el de arriba) como qubit de control.'
    width='1510'
    height='708'
  />
  <span style='max-width:1510px; padding:10px 40px'>
