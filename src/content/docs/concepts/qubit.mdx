...
title: El Qubit
description: Definición de qubit, fases global y relativa, representaciones, superposición.
---
...
magnitudes en una superposición, por lo que no tiene influencia directa sobre los resultados observables en una medición.
...
diferentes compuertas cuánticas. Cada compuerta es representada con un símbolo diferente dentro del circuito, los cuales serán presentados a continuación.

**Figura de circuito cuántico**

**Figura de compuertas cuánticas**
...
Dado que la fase global no importa, se puede seleccionar una constante $A$ que sea real. Por lo tanto,
