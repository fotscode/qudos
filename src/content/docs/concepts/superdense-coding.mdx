...
- Si Alice quiere enviar $01$, entonces aplica la puerta $X$ sobre su qubit, lo cual transforma $\ket{\Phi^+}$ en 
...
- Si Alice quiere enviar $10$, entonces aplica la puerta $Z$ a su qubit, lo cual transforma $\ket{\Phi^+}$ en 
    ...
    <TabItem label="Círculos">
        <Box>
            ...
            <div style='display: flex; flex-direction:column; align-items:center; margin-bottom:60px'>
                Se aplica una puerta Controlled-Z sobre el primer qubit con el valor del bit más significativo $d$ como bit de control,
            ...
            <div style="display: flex; flex-direction:column; align-items:center; margin-bottom:60px">
                Se aplica una puerta CNOT sobre el primer qubit con el valor del bit menos significativo $c$ como bit de control, cuyo 
            ...
            <div style='display: flex; flex-direction:column; align-items:center; margin-bottom:60px'>
                Se opera con la puerta CNOT con el primer qubit como control y el segundo qubit como target.
        ...
        <Box>
            ...
            <Aside>
                ...
                **Aclaración**: se usan los primeros dos qubits en representación de los dos bits clásicos a transferir; el tercer 
                y último qubits son entrelazados utilizando las puertas H y CNOT; los qubits intermedios simulan el envío del 
                qubit desde el emisor hacia el receptor (notar el aviso 'Send' acompañado de la puerta SWAP para intercambiar 
