...
un resultado determinado. Dicho proceso ocurre cuando el eigenvalue agregado por una puerta cuántica a un qubit es desplazado hacia un qubit 
...
Como se vio anteriormente, al aplicar una puerta $X$ sobre un qubit $\ket{-}$, se retorna la fase $-1$ 
...
En base a lo anterior puede concluirse que involucrar el operador $CNOT$ con puertas Hadamard transforma los qubits de la *base Z* $\{\ket{0}, \ket{1}\}$ a 
