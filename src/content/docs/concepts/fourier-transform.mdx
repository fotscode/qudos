...
La **transformada de Fourier cuántica (QFT)**, es otra primitiva cuántica, que se asemeja al algoritmo clásico (transformada de Fourier discreta o DFT) la cual es utilizada en distintos algoritmo. Por ejemplo el algoritmo de Shor y la primitiva de estimación de fases que este mismo utiliza.
