...
Recordando los valores de los Cubits en sus estados comunes (o bases), a continuación se detallarán las pruebas matemáticas de las conversiones de un estado común a otro utilizando la puerta Hadamard.
