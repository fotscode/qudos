...
La puerta Hadamard lleva su nombre en honor a <a href="https://es.wikipedia.org/wiki/Jacques_Hadamard" target="_blank">Jacques Hadamard</a>. Esta puerta actúa en un solo qubit y permite crear superposiciones.
...
La variante condicional de Hadamard llamada **CH**, los puntos negros representan que la puerta **H** se activa con $1$, mientras que los puntos blancos o sin relleno implican que la puerta **Z** se activa con $0$. Otro aspecto a tener en cuenta es que la puerta **CH** se aplica tanto en el control como en el objetivo. 
