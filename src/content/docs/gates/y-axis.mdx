...
Este artículo se centra en un conjunto específico de puertas que actúan sobre el eje Y. Primero se explorará la puerta **Pauli-Y**, luego la puerta **RotY** que la generaliza y, por último, se hace mención a su **variante condicional**.
...
La puerta **Pauli-Y** (o simplemente **Y**) nombrada por el físico <a href="https://en.wikipedia.org/wiki/Wolfgang_Pauli" target="_blank">Wolfgang Pauli</a> , al aplicarse, aplica una rotación de $\pi$ radianes (o 180 grados) a traves del eje $y$ de la esfera de Bloch.
...
<Recommendations />
<BibItem id='wong' prefix='Capítulo 3.3, ' rate='r' />
