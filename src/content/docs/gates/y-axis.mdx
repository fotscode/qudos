...
Recordando los valores de los Cubits en sus estados comunes (o bases), a continuacion se detallaran las pruebas matematicas de las conversiones de un estado comun a otro utilizando la puerta Pauli-Y.
