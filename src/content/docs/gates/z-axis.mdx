...
Este artículo se centra en un conjunto específico de puertas que actúan sobre el eje Z. Primero se explorará la puerta **Pauli-Z**, luego la puerta **RotZ** que la generaliza y que permite definir las puertas **S** y **T**. Por último, se hace mención a sus **variantes condicionales**.
...
La puerta **Pauli-Z** (o simplemente **Z**) nombrada por el físico <a href="https://en.wikipedia.org/wiki/Wolfgang_Pauli" target="_blank">Wolfgang Pauli</a> , al aplicarse, aplica una rotación de $\pi$ radianes (o 180 grados) a traves del eje $z$ de la esfera de Bloch.
