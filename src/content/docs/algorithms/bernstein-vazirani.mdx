...
head:
  - tag: meta
    attrs:
      { property: 'og:image', content: /quantum-katas/deutsch-jozsa-simple.png }
  - tag: meta
    attrs:
...
Sea $s=1010$ la cadena a codificar se modifica el oráculo con una función que codifica este valor oculto, utilizaremos compuertas <a href={`${import.meta.env.BASE_URL}/gates/cnot`}>CNOT</a> para codificar la cadena oculta.
