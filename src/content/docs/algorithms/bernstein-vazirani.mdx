...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  ...
  <span style='width:455px; padding:10px 40px'>
    **Figura (1):** Circuito de Deutsch-Jozsa que resuelve el problema de
    Bernstein-Vazirani con separadores ante la aplicación de cada compuerta.
  </span>
</div>
...
Sea $s=1010$ la cadena a codificar se modifica el oráculo con una función que codifica este valor oculto, utilizaremos compuertas <a href={`${import.meta.env.BASE_URL}/gates/cnot`}>CNOT</a> para codificar la cadena oculta. Este circuito se puede ver de la siguiente manera en el simulador de <a target="_blank" href="https://algassert.com/quirk">Quirk</a>:

<QuantumCircuit src={bv_example} />

Notar que el resultado de la medición representa con valores **"On"** aquellos valores que son $1$ y los que son **"Off"** los valores que son $0$, formando la cadena $1010$ si se lee de arriba hacia abajo.
