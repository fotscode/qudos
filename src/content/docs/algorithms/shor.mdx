...
head:
  - tag: meta
    attrs:
      { property: 'og:image', content: /qudos/shor/shor-pe-steps.png }
  - tag: meta
    attrs:
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    src={`${import.meta.env.BASE_URL}/shor/shor_diagram.svg`}
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    src={`${import.meta.env.BASE_URL}/shor/shor-pe-steps.png`}
