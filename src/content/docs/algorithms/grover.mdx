...
head:
  - tag: link
    attrs:
      { property: 'og-image', href: /qudos/deutsch-jozsa-simple.png }
---
...
asociado a los $n$ qubits que codifican la información de la base de búsqueda, excluyendo así a los qubits adicionales que serán utilizados para la ejecución 
del oráculo.
