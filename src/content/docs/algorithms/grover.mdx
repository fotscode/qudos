...
no posee estructura alguna. Al ser general, puede aplicarse para diferentes tipos de problema y acelerar los algoritmos clásicos 
...
A continuación se mostrará el cómputo resultante de aplicar $G$ sobre $\ket{A_0}$ y $\ket{A_1}$.
...
Despejando $t$ de la ecuación anterior se obtiene:
...
Como $t$ debe ser un valor entero mayor que 0, puede redondearse para abajo:
