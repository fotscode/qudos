...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  ...
  <span style='width:504px; padding:10px 40px'>
    **Figura (1):** Algoritmo Deutsch-Jozsa en un gráfico con separadores ante la aplicación de cada compuerta 
  </span>
</div>
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  ...
  />
  <span style='width:504px; padding:10px 40px'>
    **Figura (2):** Circuito con dos qubits, siendo el primero la entrada de la función y el
    segundo su correspondiente salida. Denota una función constante donde f(x)=0
  </span>
</div>
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    src='/deutsch-aplicado-constante.png'
  ...
  />
  <span style='width:504px; padding:10px 40px'>
    **Figura (3):** Algoritmo Deutsch-Jozsa en un gráfico con separadores ante la aplicación de cada compuerta, utilizando la función constante en vez del oráculo.
  </span>
</div>
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  ...
  />
  <span style='width:504px; padding:10px 40px'>
    **Figura (4):** Circuito con dos qubits, siendo el primero la entrada de la función y el
    segundo su correspondiente salida. Denota una función balanceada.
  </span>
</div>
...
<div style='display:flex; justify-content:center; align-items:center; flex-direction:column'>
  <Image
    src='/deutsch-aplicado-balanceada.png'
...
Esto determina que se deriva al resultado correcto, es decir que la funcion con $CNOT$ deriva en el resultado $\ket{1}$ de una función balanceada. También se puede observar en el simulador como cambio el estado de *"Off"* a *"On"*.
