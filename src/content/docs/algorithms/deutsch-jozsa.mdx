...
Se elimina el $\ket{-}$ ya que no es utilizado en la medición. Con este resultado se llega rápidamente a que, utilizando una función constante, se deriva correctamente al resultado de $\ket{0}$.
