...
- Se reemplaza el segundo qubit de $\ket{0}$ a $\ket{-}$, esto es equivalente a aplicar una puerta Pauli-X y Hadamard pero se evitó para tener una mayor legibilidad.
...
- Se aplican las puertas Hadamard a los $n$ qubits de entrada y el oráculo es aplicado a los $n$ qubits de entrada y al qubit que representa la salida de la función.
...
- <a href='https://eprint.iacr.org/2018/249.pdf' target='_blank'>
    Analysis of Deutsch-Jozsa Quantum Algorithm (Zhengjun Cao, Lihua Liu)
    [Inglés]
  </a>
- <a
    href='https://www.cl.cam.ac.uk/teaching/1920/QuantComp/Quantum_Computing_Lecture_7.pdf'
    target='_blank'
  >
    Quantum Computing (CST Part II) Lecture 7: Deutsch-Jozsa algorithm
    (Cambridge) [Inglés]
  </a>
...
- <a
    href='https://youtu.be/2wticzHE1vs?si=0kdqs3NTdlArLUPW&t=1328'
    target='_blank'
  >
    "Quantum Query Algorithms | Understanding Quantum Information & Computation
    | Lesson 05" (Qiskit) [Inglés]
  </a>
- <a href="https://learning.quantum.ibm.com/course/fundamentals-of-quantum-algorithms/quantum-query-algorithms#the-deutsch-jozsa-algorithm" target="_blank">The Deutsch-Jozsa algorithm (IBM) [Inglés]</a>
