...
Le sigue la etapa de **selección**, donde se provee un circuito que marque o distinga los estados cuánticos a buscar. Esto se hace mediante la modificación de la fase de aquellos cubits que se buscan, lo cual puede ser implementado de diferentes maneras.
...
Las últimas dos etapas pueden **repetirse** un mayor número de veces para obtener un mejor resultado, el número de iteraciones depende de la cantidad de soluciones posibles y del tamaño de la entrada. La fórmula óptima para obtener la cantidad de iteraciones es la siguiente:
