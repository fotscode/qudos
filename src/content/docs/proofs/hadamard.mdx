...
## Generalizacion de la operacion

Generalizando la operacion de hadamard aplicandoselo a un solo qubit se puede llegar a la siguiente formula:
...
donde $\alpha$ y $\beta$ son las amplitudes y $\phi$ la rotacion relativa del qubit.
