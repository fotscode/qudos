...
Recordando los valores de los Qubits en sus estados comunes (o bases), a continuacion se detallaran las pruebas matematicas de las conversiones de un estado comun a otro utilizando la <a href={`${import.meta.env.BASE_URL}/gates/hadamard`}>puerta Hadamard</a>.
