...
description: Demostraciones matemáticas de las conversiones de estados comunes utilizando la puerta Hadamard.
---

## Conversiones de estados comunes

Recordando los valores de los Cubits en sus estados comunes (o bases), a continuación se detallarán las pruebas matemáticas de las conversiones de un estado común a otro utilizando la <a href={`${import.meta.env.BASE_URL}/gates/hadamard`}>puerta Hadamard</a>.
...
Generalizando la operación de Hadamard aplicándoselo a un solo cubit se puede llegar a la siguiente fórmula:
