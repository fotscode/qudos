...
Se desarrollan pruebas matematicas de la aplicación de la <a href={`${import.meta.env.BASE_URL}/gates/cnot`}>puerta CNOT</a> en qubits en estado de superposición.
